...
func main() { // 截取第 3-5 个字符
	inputFile, _ := os.Open("D:/Study/Github/Learn-Golang/the_way_to_go/0x12/goprogram")
	outputFile, _ := os.OpenFile("D:/Study/Github/Learn-Golang/the_way_to_go/0x12/goprogramT", os.O_WRONLY|os.O_CREATE, 0666)
